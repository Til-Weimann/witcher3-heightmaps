...
for filename in os.listdir(path):
    ...
    if (filename.endswith(input_type)):
        ...
        # Read raw 16-bit file, skipping BOM with offset=BOM. Reshape.
...
# FOR /R %a IN (*.buffer) DO magick -size 512x512+0 -endian LSB -depth 16 gray:%~dpna.buffer -write MPR:orig +delete ^
